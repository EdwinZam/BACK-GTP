...
let GptService = class GptService {
    ...
    async prosConsDiscusser({ prompt }) {
        return await (0, use_cases_1.prosConsDiscusserUseCase)(this.openai, { prompt });
    }
    async prosConsDiscusserStream({ prompt }) {
        return await (0, use_cases_1.prosConsDiscusserStreamUseCase)(this.openai, { prompt });
    }
    ...
    async audioToText(audioFile, prompt) {
